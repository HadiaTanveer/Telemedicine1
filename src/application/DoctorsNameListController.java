...
public class DoctorsNameListController  implements Initializable{
	@FXML
	private Button back;
	@FXML
	private Color x1;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		for(int i = 0; i < p.doctors_Record.size(); i++) {
			...
			String pat = id + ".        " + name + "   \t  \t\t " + p.getD_Department() + "   \t  \t\t" + availability;
			doctors.add(pat);
			
		}
		list.getItems().addAll(doctors);
		...
		list.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>() {
			...
			public void changed(ObservableValue<? extends String> arg0, String arg1, String arg2) {
				...
				int id = 0;
		          ...
		          DoctorsNameListController dn = new DoctorsNameListController();
    ...
    @FXML
    void selectDoctor(ActionEvent event) throws IOException {
    	Stage s = (Stage)((Node)event.getSource()).getScene().getWindow();
